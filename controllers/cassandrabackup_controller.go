...
// +kubebuilder:rbac:groups=cassandra.k8ssandra.io,resources=cassandrabackups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cassandra.k8ssandra.io,resources=cassandrabackups/status,verbs=get;update;patch
...
func (r *CassandraBackupReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&cassandrav1alpha1.CassandraBackup{}).
		Complete(r)
}
